...
def train(model, dataloader, criterion, optimizer, args, device):
    min_loss = float('inf')
    mean_loss = 0.0
...
if __name__ == '__main__':
    '''
    Usage:
        python train.py --emb_path data/start_128_train --model_path models/eph20dim256_start128.pth --hidden_dim 256 --epochs 20
    '''
    ...
    parser.add_argument('--model_path', type=str, default='models/inversion_dist_model.pth', help='Path to the model')
    ...
    train(model, dataloader, criterion, optimizer, args, device)