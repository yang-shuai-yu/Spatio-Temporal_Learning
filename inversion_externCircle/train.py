...
if __name__ == '__main__':
    ...
    # python train.py --emb_path data/t2vec_256_train --model_path models/eph50dim512_t2vec128.pth --dist_path data/circle/traincircle --epochs 50
    # python train.py --emb_path data/t2vec_128_test --model_path models/externCircle_t2vec128.pth --dist_path data/circle/testcircle --epochs 20
    ### === Example === ###

    # Set up the argument parser
    parser = argparse.ArgumentParser(description='Inversion Distance Model')
    parser.add_argument('--dist_path', type=str, default='data/circle/traincircle', help='Path to the distance data')
