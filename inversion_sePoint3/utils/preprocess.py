...
def prepare_data(data_path, data_name, emb_dim):
    ...
    train_trajs = rtrain_trajs[:18_0000]; train_embs = rtrain_embs[:18_0000]
...
if __name__ == '__main__':
    # 做归一化，不要搞grid了
    os.chdir("/home/yangshuaiyu6791/RepresentAttack/inversion_sePoint3/")    # change the current directory to inversion_sePoint
